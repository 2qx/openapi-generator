...
public class TypeScriptExpressServerCodegen extends DefaultCodegen implements CodegenConfig {

    private static final Logger LOGGER = LoggerFactory.getLogger(TypeScriptExpressServerCodegen.class);
    ...
    public TypeScriptExpressServerCodegen() {
        super();
        ...
        outputFolder = "generated-code/typescript-express-server";
    ...
    public String getHelp() {
        return "Generates a TypeScript Express server (alpha). IMPORTANT: this generator may subject to breaking changes without further notice).";
    }
